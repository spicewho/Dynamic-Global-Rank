...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/Spice/Documents/GeodeMods/Dynamic Global Rank/build/_deps/asp2-src"
...
execute_process(
  COMMAND "T:/Programs (x69)/Git/cmd/git.exe" --git-dir=.git show-ref "87c2105"
  WORKING_DIRECTORY "C:/Users/Spice/Documents/GeodeMods/Dynamic Global Rank/build/_deps/asp2-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("87c2105" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 87c2105")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/87c2105")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"87c2105\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Spice/Documents/GeodeMods/Dynamic Global Rank/build/_deps/asp2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Spice/Documents/GeodeMods/Dynamic Global Rank/build/_deps/asp2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
