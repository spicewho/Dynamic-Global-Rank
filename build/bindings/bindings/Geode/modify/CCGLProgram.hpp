...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCGLProgram> : ModifyBase<ModifyDerive<Der, cocos2d::CCGLProgram>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<unsigned int, cocos2d::GLInfoFunction, cocos2d::GLLogFunction>::func(&cocos2d::CCGLProgram::logForOpenGLObject)), Thiscall, cocos2d::CCGLProgram, logForOpenGLObject, unsigned int, cocos2d::GLInfoFunction, cocos2d::GLLogFunction)
