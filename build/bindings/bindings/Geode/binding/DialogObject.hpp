...
public:
     ...
     */
    static DialogObject* create(gd::string character, gd::string text, int characterFrame, float textScale, bool unskippable, cocos2d::ccColor3B nameColor);
     ...
     * @note[short] Android: Rebinded
     */
    bool init(gd::string character, gd::string text, int characterFrame, float textScale, bool unskippable, cocos2d::ccColor3B nameColor);
    gd::string m_text;
