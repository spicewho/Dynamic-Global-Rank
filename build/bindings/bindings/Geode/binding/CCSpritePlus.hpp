...
Creates a sprite by a given sprite frame
 ...
 @return CCSpritePlus object and returns null if initialization fai     * @note[short] MacOS (ARM): 0x3e7aa4
...
Creates a sprite by a given sprite's frame name
 ...
 @return CCSpritePlus object and returns null if initialization fai     * @note[short] MacOS (ARM): 0x3e7b54
...
Sets X's scale on itself and it's followers
 ...
 @param scaleX the scale of X to s     * @note[short] MacOS (ARM): 0x3e7f84
...
Sets Y's scale on itself and it's followers
 ...
 @param scaleY the scale of Y to s     * @note[short] MacOS (ARM): 0x3e8008
...
Sets the Scale of itself and it's followers
 ...
 @param scale the scale value to s     * @note[short] MacOS (ARM): 0x3e808c
...
Sets the position where the sprite will be at and it's followers
 ...
 @param position the position to place to the sprite and it's followe     * @note[short] MacOS (ARM): 0x3e7c34
...
Sets the sprite's given rotation and it's followers
 ...
 @param rotation the rotation value to s     * @note[short] MacOS (ARM): 0x3e7cac
...
Sets the sprite's given rotation of X and it's followers
 ...
 @param rotationX the rotation of X to se     * @note[short] MacOS (ARM): 0x3e7d24
...
Sets the sprite's given rotation of Y and it's followers
 ...
 @param rotationY the rotation of Y to s     * @note[short] MacOS (ARM): 0x3e7d9c
...
Initalizes the sprite using a texture
 ...
 @return true if initalization succeede     * @note[short] MacOS (ARM): 0x3e7c20
...
Initalizes the sprite with a frame name
 ...
 @return true if initalization succeed     * @note[short] MacOS (ARM): 0x3e7c14
...
Adds a follower to the sprite
 ...
 @param follower Something that will follow this spri     * @note[short] MacOS (ARM): 0x3e8110
...
Attaches a sprite to the sprite. and other way around
 ...
 @param sprite the sprite to attach to the main sprite and vice ver     * @note[short] MacOS (ARM): 0x3e81a8
...
Obtains the first following sprite if it has a follower on hand
 ...
 @return nullptr if there is no follower avalib     * @note[short] MacOS (ARM): 0x3e8250
...
Removes a specific following sprite from this sprite.
 ...
 @param sprite follower sprite that will be remove     * @note[short] MacOS (ARM): 0x3e8160
    ...
    /**
Stops this child sprite from following it's given pare     * @note[short] MacOS (ARM): 0x3e8200
