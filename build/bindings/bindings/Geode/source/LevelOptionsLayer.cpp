...
LevelOptionsLayer::LevelOptionsLayer() : LevelOptionsLayer(geode::CutoffConstructor, sizeof(LevelOptionsLayer)) {
	...
	using FunctionType = void(*)(LevelOptionsLayer*);
	static auto func = wrapFunction<FunctionType>(base::get() + 0x31e730, tulip::hook::TulipConvention::Thiscall);
