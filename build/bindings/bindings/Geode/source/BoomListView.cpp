...
BoomListView::BoomListView() : BoomListView(geode::CutoffConstructor, sizeof(BoomListView)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x3be90, tulip::hook::TulipConvention::Thiscall);
